        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center">
                <div class="shrink-0 flex items-center">
                    <a href="{{ (Auth::check() && Auth::user()->is_admin) ? route('admin.dashboard') : url('/') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="block h-9 w-9 text-secondary" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l9-9 9 9" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 10.5v9A1.5 1.5 0 006 21h3v-6h6v6h3a1.5 1.5 0 001.5-1.5v-9" />
                        </svg>
                    </a>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-secondary bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                @endif
            @endauth
            <x-responsive-nav-link :href="route('pay.index')" :active="request()->routeIs('pay.index')">{{ __('nav.pay') }}</x-responsive-nav-link>
        </div>
